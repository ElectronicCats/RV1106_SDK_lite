...
log "[03] Building Rootfs..."; bash scripts/03-build-rootfs.sh
log "[03b] Building packages..."; cd pkg; bash pkg.sh build-all && bash pkg.sh install-all; cd ..
log "[04] Packing images...";  bash scripts/04-pack-image.sh
log "=== Build complete ==="
